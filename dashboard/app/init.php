...
/**
 * ============================================================================
 * Netking Dashboard - Initial Setup Wizard
 * ============================================================================
...
<head>
    ...
    <title>Netking - Initial Setup</title>
...
<body>
    <div class="container">
        <div class="setup-card">
            <div class="card-header">
                <div class="logo-container">
                    <img src="assets/img/logo.png" alt="Netking Logo" class="logo-img">
                </div>
                <h1>Netking Setup</h1>
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        <p class="mb-2">Netking Dashboard membutuhkan GenieACS (TR-069 ACS) untuk mengelola perangkat ONU.</p>
                        <p class="mb-0">
                            <i class="bi bi-github"></i>
                            <strong>Panduan instalasi lengkap GenieACS di Ubuntu 22.04:</strong><br>
                            <a href="https://netking.id" target="_blank" rel="noopener noreferrer" class="text-decoration-none" style="font-weight: 600;">
                                https://netking.id
        ...
        <div class="text-center mt-4 text-white">
            <small>Powered by <a href="https://netking.id" target="_blank" rel="noopener noreferrer" class="text-white text-decoration-none" style="font-weight: 600; border-bottom: 1px dotted white;">Netking</a></small>
        </div>
    </div>
