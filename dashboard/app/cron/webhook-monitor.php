 ...
 *
 * Add to crontab:
 * Every 5 minutes -> /usr/bin/php /path/to/your/project/cron/webhook-monitor.php
 */

require_once __DIR__ . '/../config/config.php';

if (strtolower((string) envValue('TELEGRAM_BOT_TRANSPORT', 'webhook')) === 'polling') {
    error_log("[Webhook Monitor] Polling mode enabled, skipping webhook enforcement");
    exit(0);
}
