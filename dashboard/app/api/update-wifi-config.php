...
requireLogin();
enforceCpeWriteGuard('Update WiFi ONT');
...
// Validate password length only when password is provided.
// Empty password means "keep existing password on device".
