...
// Add legacy OLT count from server properties (items with olt_link configured).
// New deployments should use real `olt` map_items, but older data may still
// store OLT references on server properties.
