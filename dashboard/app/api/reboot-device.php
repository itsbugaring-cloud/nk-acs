...
requireLogin();
enforceCpeWriteGuard('Reboot ONT');
...
$taskResult = $genieacs->rebootDevice($deviceId);

if ($taskResult['success']) {
    jsonResponse([
        'success' => true,
        'message' => 'Task reboot berhasil dikirim ke device',
...
jsonResponse([
    'success' => false,
    'message' => 'Gagal kirim reboot: ' . ($taskResult['error'] ?? 'Unknown error'),
    'http_code' => $taskResult['http_code'] ?? null
], 400);
